...
# define INPUT_FILE		"myinputfile.csv"
...
# define AUTO_DETECTION				true
	...
	// IF AUTO DETECTION IS >true< SET PARAMETERS BELOW
		...
		# define CROP_SIZE_LIMIT		true
			# define MAX_CROP_SIZE		128

		// # of pixels of margin to also copy around found object (if not exceeding SIZE_LIMIT)
		# define MARGIN					10
	...
	// IF AUTO DETECTION IS >false< SET PARAMETERS BELOW
		...
		# define CROP_WIDTH				128
		// height of the cropped image (in # of pixels)
		# define CROP_HEIGHT			128


// scale for output preview, skip every n'th pixel
# define SCALE					10
